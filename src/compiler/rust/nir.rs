...
impl nir_intrinsic_instr {
    ...
    pub fn src_type(&self) -> nir_alu_type {
        self.get_const_index(NIR_INTRINSIC_SRC_TYPE) as nir_alu_type
    }

    pub fn dest_type(&self) -> nir_alu_type {
        self.get_const_index(NIR_INTRINSIC_DEST_TYPE) as nir_alu_type
    }
